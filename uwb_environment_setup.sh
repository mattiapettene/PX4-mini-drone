...
gnome-terminal --tab --working-directory="$directory" -- bash -c "export ROS_DOMAIN_ID=0; export PYTHONOPTIMIZE=1; make px4_sitl gazebo-classic_iris PX4_SITL_WORLD=my_world"
